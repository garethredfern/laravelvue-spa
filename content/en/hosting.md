...
**It’s very important you add these otherwise sessions and Sanctum will not work.** Also note the period `.laravelvuespa.app` before the domain name, this allows for the API to run on a subdomain and still have sessions work.
...
While your app can be viewed at yoursite.netlify.app you need it to be routed to your own domain name. On the far right hand side of the top menu click on site settings.
